...
--- | --- | --- | ---
[Выбор локации для скважины](https://github.com/s-mudro/08_well_location_selection)| Выбор локации для новой скважины с учетом возможной прибыли и рисков | Модель машинного обучения, которая поможет определить регион, где добыча принесёт наибольшую прибыль | pandas, numpy, matplotlib.pyplot, sklearn, seaborn
